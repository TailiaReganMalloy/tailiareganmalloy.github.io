    ...
    <div class="max-w-3xl mx-auto py-12 px-4">
      ...
      <div v-else>
        ...
        <div class="mt-8 text-center">
          <button @click="showDetail = false" class="px-4 py-2 rounded bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600">Back</button>
        </div>
      </div>
    </div>
  </div>
