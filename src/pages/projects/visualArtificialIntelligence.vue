...
import cyberSecurityImage from '@/assets/img/VisualArtificialIntelligence.png';

export const meta = {
  title: 'Visual Aritificial Intelligence',
...
const projectPapers = useProjectPapers('visualAritificalIntelligence');
</script>
